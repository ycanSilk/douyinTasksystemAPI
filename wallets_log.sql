...
) ENGINE = InnoDB AUTO_INCREMENT = 166 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '钱包流水表-记录所有收支' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `wallets_log` VALUES (27, 7, 3, 'task', 2, 2, 1000, 167800, 166800, 'rental_freeze', 5, NULL, NULL, '求租信息冻结预算（1000分/天×1天）：发布求租信息更新。抖音', '2026-03-03 21:25:27');
...
INSERT INTO `wallets_log` VALUES (33, 1, 1, 'Ceshi', 2, 2, 3000, 218600, 215600, 'task', 14, NULL, NULL, '发布任务【上评评论】10个任务，扣除 ¥30.00', '2026-03-04 20:03:07');
