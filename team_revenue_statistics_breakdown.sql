...
) ENGINE = InnoDB AUTO_INCREMENT = 11 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '团队收益明细表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of team_revenue_statistics_breakdown
-- ----------------------------
INSERT INTO `team_revenue_statistics_breakdown` VALUES (1, 103, 'user103', 1, 106, 'user106', 25.00, 25.00, 0.00, 25.00, 'TASK001', 1, '任务收益', 3, '评论任务', 2, '已完成', NULL, NULL, '2026-03-17 10:21:19');
INSERT INTO `team_revenue_statistics_breakdown` VALUES (2, 101, 'user101', 2, 106, 'user106', 25.00, 25.00, 0.00, 25.00, 'TASK001', 1, '任务收益', 3, '评论任务', 2, '已完成', NULL, NULL, '2026-03-17 10:21:19');
INSERT INTO `team_revenue_statistics_breakdown` VALUES (3, 103, 'user103', 1, 107, 'user107', 30.00, 30.00, 25.00, 55.00, 'TASK002', 1, '任务收益', 3, '评论任务', 2, '已完成', NULL, NULL, '2026-03-17 10:21:19');
INSERT INTO `team_revenue_statistics_breakdown` VALUES (4, 101, 'user101', 2, 107, 'user107', 30.00, 30.00, 25.00, 55.00, 'TASK002', 1, '任务收益', 3, '评论任务', 2, '已完成', NULL, NULL, '2026-03-17 10:21:19');
INSERT INTO `team_revenue_statistics_breakdown` VALUES (5, 104, 'user104', 1, 108, 'user108', 50.00, 50.00, 0.00, 50.00, 'ORDER001', 2, '账号出租收益', NULL, NULL, NULL, NULL, 1, '出租订单', '2026-03-17 10:21:19');
INSERT INTO `team_revenue_statistics_breakdown` VALUES (6, 101, 'user101', 2, 108, 'user108', 50.00, 50.00, 55.00, 105.00, 'ORDER001', 2, '账号出租收益', NULL, NULL, NULL, NULL, 1, '出租订单', '2026-03-17 10:21:19');
INSERT INTO `team_revenue_statistics_breakdown` VALUES (7, 105, 'user105', 1, 109, 'user109', 20.00, 20.00, 0.00, 20.00, 'TASK003', 1, '任务收益', 3, '评论任务', 2, '已完成', NULL, NULL, '2026-03-17 10:21:19');
INSERT INTO `team_revenue_statistics_breakdown` VALUES (8, 102, 'user102', 2, 109, 'user109', 20.00, 20.00, 0.00, 20.00, 'TASK003', 1, '任务收益', 3, '评论任务', 2, '已完成', NULL, NULL, '2026-03-17 10:21:19');
INSERT INTO `team_revenue_statistics_breakdown` VALUES (9, 105, 'user105', 1, 110, 'user110', 45.00, 45.00, 20.00, 65.00, 'ORDER002', 2, '账号出租收益', NULL, NULL, NULL, NULL, 1, '出租订单', '2026-03-17 10:21:19');
INSERT INTO `team_revenue_statistics_breakdown` VALUES (10, 102, 'user102', 2, 110, 'user110', 45.00, 45.00, 20.00, 65.00, 'ORDER002', 2, '账号出租收益', NULL, NULL, NULL, NULL, 1, '出租订单', '2026-03-17 10:21:19');
